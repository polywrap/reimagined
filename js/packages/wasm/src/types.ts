...
export interface WrapExports extends WebAssembly.Exports {
  _wrap_invoke: (classNameLen: u32, methodNameLen: u32, argsLen: u32) => boolean;
  _wrap_instantiate: (classNameLen: u32, argsLen: u32) => boolean;
  _wrap_invoke_instance: (classNameLen: u32, classInstancePtr: u32, methodNameLen: u32, argsLen: u32) => boolean;
}
